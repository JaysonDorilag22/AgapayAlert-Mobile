...
export const GET_SINGLE_REPORT_FAIL = 'GET_SINGLE_REPORT_FAIL';
export const GET_REPORTS_BY_USER_REQUEST = 'GET_REPORTS_BY_USER_REQUEST';
export const GET_REPORTS_BY_USER_SUCCESS = 'GET_REPORTS_BY_USER_SUCCESS';
export const GET_REPORTS_BY_USER_FAIL = 'GET_REPORTS_BY_USER_FAIL';
...
//SIGHTING
export const GET_SIGHTINGS_REQUEST = 'GET_SIGHTINGS_REQUEST';
export const GET_SIGHTINGS_SUCCESS = 'GET_SIGHTINGS_SUCCESS';
export const GET_SIGHTINGS_FAIL = 'GET_SIGHTINGS_FAIL';
export const GET_SINGLE_SIGHTING_REQUEST = 'GET_SINGLE_SIGHTING_REQUEST';
export const GET_SINGLE_SIGHTING_SUCCESS = 'GET_SINGLE_SIGHTING_SUCCESS';
export const GET_SINGLE_SIGHTING_FAIL = 'GET_SINGLE_SIGHTING_FAIL';
export const CREATE_SIGHTING_REQUEST = 'CREATE_SIGHTING_REQUEST';
export const CREATE_SIGHTING_SUCCESS = 'CREATE_SIGHTING_SUCCESS';
export const CREATE_SIGHTING_FAIL = 'CREATE_SIGHTING_FAIL';
export const EDIT_SIGHTING_REQUEST = 'EDIT_SIGHTING_REQUEST';
export const EDIT_SIGHTING_SUCCESS = 'EDIT_SIGHTING_SUCCESS';
export const EDIT_SIGHTING_FAIL = 'EDIT_SIGHTING_FAIL';
export const DELETE_SIGHTING_REQUEST = 'DELETE_SIGHTING_REQUEST';
export const DELETE_SIGHTING_SUCCESS = 'DELETE_SIGHTING_SUCCESS';
export const DELETE_SIGHTING_FAIL = 'DELETE_SIGHTING_FAIL';
export const CLEAR_SIGHTING_STATE = 'CLEAR_SIGHTING_STATE';
export const GET_SIGHTINGS_BY_USER_REQUEST = 'GET_SIGHTINGS_BY_USER_REQUEST';
export const GET_SIGHTINGS_BY_USER_SUCCESS = 'GET_SIGHTINGS_BY_USER_SUCCESS';
export const GET_SIGHTINGS_BY_USER_FAIL = 'GET_SIGHTINGS_BY_USER_FAIL';
